...
# ----------------------------------------
subparagraph: no  # si secspace: yes nécessaire avec titlesec sinon erreur avec paragraph et subp
...
```{r graphe, message=FALSE}
library(UsingR)
library(ggplot2)
# suppressPackageStartupMessages(UsingR)
data("galton")

ggplot(galton, aes(parent, child)) + geom_jitter(width = .5, height = .5, alpha = .5)
