...
# si la section authordetails est présente, la section author est désactivée
authordetails: 
...
logo: yes
logopath: common/logoipag #extension omitted
logowidth: 50pt
...
footer: \theshortauthor \ --\ \theshorttitle \ --\ page\ \thepage #mod template
# babel: english # francais # english
...
subparagraph: yes  # nécessaire avec titlesec sinon erreur avec paragraph et subp
---
...
$$F_\psi(x_i) = e^x \cdot \int_i^x{\frac{t^{3^\beta}}{2\psi(i)}\ dt}$$
