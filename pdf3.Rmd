...
shortauthor: Bruno et al.

date: "`r paste0('Revision: 26 juillet 2018, edition: ',  format(Sys.Date(), '%d %B %Y') )`"
...
toc-sommaire: yes # si lang = fr et si la table est au début du doc, yes u true
# nom de la table = "Sommaire"

debug_var: yes # pour afficher les variables dans le texte
