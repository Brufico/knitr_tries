...
toc_sommaire: true # si lang = fr et si la table est au début du doc, yes u true
# nom de la table = "Sommaire"

debug_var: true # pour afficher les variables dans le texte
...
subparagraph: yes  # nécessaire avec titlesec sinon erreur avec paragraph et subparagraph
---
