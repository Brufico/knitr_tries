---
title: "Pdf (Latex) tries"
subtitle : "Une sorte d'exploration pour utiliser un template."
author: BFC
abstract: "This is just an experiment on formatting with a new template"
...
# - \fancyfoot[C]{\thetitle \ \textemdash \ \thepage}
- \fancyfoot[CE,CO]{\theauthor} # thetitle ne marche pas et donne le n0 de section
...
urlcolor: blue
fontsize: 12pt
geometry: "a4paper, left=2cm,right=2cm,top=2cm,bottom=2cm,headsep=0.5cm,footskip=1cm"
subparagraph: yes  # nécessaire avex titlesec 
---
...
![](common/logoipag.jpg){width=100px}
