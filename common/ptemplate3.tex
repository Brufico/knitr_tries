...
\pagestyle{fancy}
\fancyhf{}
\renewcommand{\headrulewidth}{0pt} % no header decorative line
...
\titlespacing\section{-10pt}{*4}{*2.3}
\titlespacing\subsection{-10pt}{*3.5}{*1.5}
\titlespacing\subsubsection{-10pt}{*3}{*1}
\titlespacing\paragraph{0pt}{*2}{*1}
\titlespacing\subparagraph{0pt}{*.6}{*0}

% changer le nom de la table des matières (content)
...
% added logo. does'nt work yet (title gets on next page)
\begin{figure}[H]
\centering
