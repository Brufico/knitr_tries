...
# classoption: a4paper
header-includes: \usepackage{float}\usepackage{graphicx}\usepackage{titling}\usepackage{fancyhdr}\pagestyle{fancy} \fancyfoot[C]{\thetitle \ \textemdash \ page \thepage}
# footer:  \thetitle \ \textemdash \ \thepage
output: 
    pdf_document:
      number_section: yes
      toc: yes
      template: ptemplate2.tex
urlcolor: blue
fontsize: 12pt
...
![](common/logoipag_mail.jpg){width=100px}
