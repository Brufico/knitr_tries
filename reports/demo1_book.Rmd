...
# résumé ==> Pas de résumé dans la classe book.
# abstract: |
...
output: 
    ...
    #   # mathjax: "default"
    #   # self_contained: no # default = yes
    #   number_section: yes
    #   fig_caption: yes
    #   theme: readable
    #   # template: ../common/ptemplate.html # en HTML, empeche mathjax de fonctionner
...
# Mathjax non fonctionnel (fonctionne ok !!!!)
# mathjax: "https://mathjax.rstudio.com/latest/MathJax.js?config=TeX-AMS-MML_HTMLorMML"
...
```{r graphe, message=FALSE, warning=FALSE, fig.cap=figcap("just a Scatterplot"), fig.pos= "H"}
library(ggplot2)
data("galton")
# faire le graphe
...
Le code de la figure `r .rfig("grapheloess")` :
