...
Vivamus
-------
Dans ce paragraphe : fotnote multi-paragraphe, réfarence à un tableau, lien avec texte, équation.

Vivamus a tellus[^longnote]. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Proin pharetra nonummy pede. Mauris et orci. Référence au tableau `r .rtab("table")`.
...
Dans ce paragraphe : 2 références à une figure, puis référence à une section, puis génération de figure (code chunk affiché).
...
Laborator manusque hic caput. *un inline chunk ne fonctionne pas ici parce que l'image ne semble pas redimensionnable. voir avec les packages jpeg et png*
...
Référence tableau: (comme dans le tableau `r .rtab("table")`)
